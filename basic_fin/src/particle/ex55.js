...
import { ImagePannel } from "./ImagePanel";
...
export default function example() {
  ...
  for (let i = 0; i < spherePositionArray.length; i += 3) {
    imagePanel = new ImagePannel({
      textureLoader,
      scene,
      geometry: planeGeometry,
      imageSrc: `particle/0${Math.ceil(Math.random() * 5)}.jpg`,
  ...
  sphereBtn.style.cssText = "position: absolute; left: 20px; top: 60px";
